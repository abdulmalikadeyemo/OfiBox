...
API_BASE_URL = "http://dd639f591b7144c7f842ee9ef8e0b4eb5.clg07azjl.paperspacegradient.com"  # or whatever port your api_server is running on
HAS_T2I=True
...
def generation_all(
    ...
    params = {
        ...
        "octree_resolution": octree_resolution,
        "num_chunks": num_chunks,
        "texture": True,  # Explicitly set texture to True
    }
    ...
    if image is not None:
        ...
        params["image"] = base64.b64encode(buffered.getvalue()).decode()
